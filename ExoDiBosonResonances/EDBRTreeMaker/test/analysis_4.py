...
'file:/eos/user/q/qiguo/aQGC/condor/private_sample/WWW/v2/miniaod_8764611_38.root'#,'file:/eos/user/q/qiguo/temp/miniaod_8350145_1.root','file:/eos/user/q/qiguo/temp/miniaod.root'
...
process.TFileService = cms.Service("TFileService",
                                   fileName = cms.string("RStreeEDBR_pickup_LO_4.root")
                                   )
